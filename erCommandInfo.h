...
#define RESERVED_BANDMEMORY_START 0x1B0
#define RESERVED_BANDMEMORY_COUNT 5
#define TRANSVERTER_BANDMEMORY_START 0x0200
#define TRANSVERTER_BANDMEMORY_COUNT 9
#define BANDMEMORY_SIZE 0x10
#define BANDMEMORY_COUNT \
	NORMAL_BANDMEMORY_START+RESERVED_BANDMEMORY_COUNT+TRANSVERTER_BANDMEMORY_COUNT
